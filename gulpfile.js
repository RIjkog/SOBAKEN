...
const cache = () => {
	return src('dist/**/*.{css,js,svg,png,jpg,jpeg,woff,woff2}', {
		base: 'dist'
	})
		.pipe(rev())
		.pipe(revDel())
...
exports.build = series(toProd, clean, htmlInclude, scripts, styles, resources, images, svgSprites, htmlMinify, git);
